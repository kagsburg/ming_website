...
if (isset($_GET['del'])) {
    $id = $_GET['del'];
    $update = $db->query("UPDATE `youtube_links` SET `status`='0' WHERE id='".$id."'");
    header('location: youtube_videos');
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="javascript.void(0)" data-toggle="modal" data-target="#addPortfolio" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas  fa-plus  fa-sm text-white-50"></i> Add New Youtube Videos</a>
                    </div>
                    ...
                    <?php 
                        if (isset($_POST['submitYoutube'])){
                            ...
                            $insert = $db->query("INSERT INTO `youtube_links`(`link`,`caption`,`status`) VALUES ('".$link."','".$caption."','".$status."')"); 
                        
                            if ($insert){
                                echo '<div class="alert alert-success alert-icon" role="alert">
                                <div class="alert-icon-content">
                                    <h6 class="alert-heading">Success</h6>
                                    New Youtube Video Added Successfully.
                                </div>
                            </div>';
                            }
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <?php 
                             $fetchVideos = mysqli_query($db, "SELECT * FROM youtube_links where status ='1' ORDER BY id DESC");
                            ...
                            <div class="card">
                            <iframe height="200" src="<?php echo $row["link"]."?autoplay=1&mute=1"; ?>">
                                    </iframe>
                                <div class="card-body">
                                    ...
                                    <a href="youtube_videos?del=<?php echo $row['id'] ?>" class="btn btn-danger btn-circle " onclick="return confirm('Are you sure you want to delete?')">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"> Add New Youtube Video</h5>
                        ...
                        <form action="" method="POST"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-2"><label for="link"
                                                        class=" form-control-label">Youtube
                                                        Link:</label>
                                                </div>
                                                <div class="col-12 col-md-9"><input type="text" id="link" name="link"
                                                        placeholder="YouTube Video Link: https://www.youtube.com/embed/hxWLJ5Zj" class="form-control"></div>
                                            </div>

                                            <div class="form-group">
                                                <button class=" btn btn-success w-100" type="submit" name="submitYoutube">Add
